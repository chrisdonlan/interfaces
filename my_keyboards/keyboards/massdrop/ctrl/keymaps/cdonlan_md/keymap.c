...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LT(1,KC_TAB),  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,   KC_DEL,  KC_END,  KC_PGDN, \
    ...
    [1] = LAYOUT(
        ...
        _______,  L_T_BR,   L_PSD,   L_BRI,   L_PSI, U_T_AGCR,  DF(0),   DF(2),   DF(3),   DF(4), _______, _______, _______, _______,   KC_MPRV, KC_MNXT, KC_VOLD, \
   ...
   LT(5,KC_TAB), KC_QUOT, KC_COMM,  KC_DOT,    KC_P,    KC_Y,    KC_F,    KC_G,    KC_C,    KC_C,    KC_R,    KC_L, KC_SLSH,  KC_EQL,   _______, _______, _______, \
    ...
    [4] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, \
   LT(5,KC_TAB), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, \
        _______, KC_MS_LEFT, KC_MS_UP, KC_MS_DOWN, KC_MS_RIGHT, M(4), KC_LEFT, KC_DOWN, KC_UP,KC_RGHT, M(9), M(10), _______, \
