...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        TT(1,KC_TAB),  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, KC_HOME, \
    ...
    [1] = LAYOUT(
        ...
        KC_TRNS, L_T_MD,  L_T_ONF, KC_TRNS, KC_TRNS, MD_BOOT, TG_NKRO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          DF(2),   KC_VOLD,\
        KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS,                            KC_TRNS, KC_TRNS, DF(0),   DF(4),   DF(3)\
    ),
    ...
    [3] = LAYOUT(
        ...
        TT(5,KC_TAB),  KC_QUOT, KC_COMM, KC_DOT,  KC_P,    KC_Y,    KC_F,    KC_G,    KC_C,    KC_R,    KC_L,    KC_SLSH, KC_EQL,  KC_BSLS, KC_HOME, \
    ...
    [4] = LAYOUT(
        ...
        LT(5,KC_TAB),  KC_1,          KC_2,         KC_3,          KC_4,           KC_5,    KC_6,       KC_7,          KC_8,        KC_9,        KC_0,    KC_MINS, KC_EQL,  KC_BSLS, KC_HOME, \
        KC_CAPS,   KC_MS_LEFT,    KC_MS_UP,     KC_MS_DOWN,    KC_MS_RIGHT,    M(4),    KC_LEFT,    KC_DOWN,       KC_UP,       KC_RGHT,     M(9),    M(10),            KC_ENT,  KC_PGUP, \
